      ...
      <div className="right-container">
        <div className="content">
          ...
          <div className="top-right">
            <img
              src="https://images.crexi.com/users/77872/c1da142587284cf3a18fb696aeb7dc66_164x164.jpg"
              className="contact-avatar margin-b"
            />
          ...
          <div className="toggle-container">
            ...
            <div
              className={
                isOpen ? "right option" : "right option selected-toggle"
              }
              onClick={toggleButton}
            >
              Notes
          ...
          <div className={isOpen ? "notes hide" : "notes"}>
            <div className="note-container">
              <div className="top note">
                Today 9:35 AM by <b>Jon Fletcher</b>
              </div>
              <div className="note-box">
                <div className="actual-note">
                  Had a call with Gillian last week. She sounded very interested
                  in moving forward with 7-11
                </div>
              </div>
              <div className="bottom-note note">
                Posted on <b>7-11</b>
              </div>
            </div>
          ...
          <div className={isOpen ? "about" : "about hide"}>
            <div className="drawer-content about">
              ...
              <div className="about-info">
                ...
                <div className="about-row">
                  <div className="about-item about-left">
                    Assets Under Mangagement
                  </div>
                  <div className="about-item about-line"></div>
                  ...
                  <div className="activity-container">
                    ...
                    <div className="activity-right-block">
                      <div className="activity-property">
                        <img className="act-property" src={sevenEleven} />
                      </div>
                      <div className="activity-property name">
                        7-11 on 785 Main St. Grand...
                      </div>
                    </div>
                  </div>
                </div>
